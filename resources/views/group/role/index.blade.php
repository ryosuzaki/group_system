                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning btn-sm btn-round m-0 text-white" href="{{route('group.role.edit_permissions',[$group->id,$role->index])}}"><i class="material-icons">lock_open</i> 権限</a>
                            @endcan
